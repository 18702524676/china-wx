...
<head>
    ...
    <link rel="stylesheet" href="/permission/ztree/zTreeStyle.css" type="text/css">
    <link rel="stylesheet" href="/permission/assets/css/bootstrap-duallistbox.min.css" type="text/css">
    <script type="text/javascript" src="/permission/ztree/jquery.ztree.all.min.js"></script>
    <script type="text/javascript" src="/permission/assets/js/jquery.bootstrap-duallistbox.min.js"></script>
    <style type="text/css">
...
<script type="text/javascript">
    $(function () {
        ...
        function loadRoleList() {
            $.ajax({
                url: "/permission/sys/role/getSysRoleAll.json",
                success: function (result) {
                    if (result.status == 200) {
                        ...
                        showMessage("加载角色列表", result.message, false);
                    }
                }
            });
        }
                    ...
                    buttons : {
                        "修改": function(e) {
                            ...
                            updateRole(false, function (data) {
                                showMessage("修改角色", data.message, true);
                                $("#dialog-role-form").dialog("close");
                            }, function (data) {
                                showMessage("修改角色", data.message, false);
                            })
                        },
                        "取消": function () {
                            $("#dialog-role-form").dialog("close");
        ...
        function loadRoleAcl(selectedRoleId) {
            ...
            $.ajax({
                url: "/permission/sys/role/roleTree.json",
                data : {
                ...
                success: function (result) {
                    if (result.status == 200) {
                        ...
                        showMessage("加载角色权限数据", result.message, false);
                    }
                }
            });
        }
        ...
        function recursivePrepareTreeData(aclModuleList) {
            ...
            if (aclModuleList && aclModuleList.length > 0) {
                $(aclModuleList).each(function(i, aclModule) {
                    ...
                    if (aclModule.sysAclVOList && aclModule.sysAclVOList.length > 0) {
                        $(aclModule.sysAclVOList).each(function(i, acl) {
                            zTreeObj.push({
                                id: aclPrefix + acl.id,
                    ...
                    if ((aclModule.treeVOList && aclModule.treeVOList.length > 0) ||
                        (aclModule.sysAclVOList && aclModule.sysAclVOList.length > 0)) {
                    ...
                    recursivePrepareTreeData(aclModule.treeVOList);
                });
            }
        }
        ...
        $(".saveRoleAcl").click(function (e) {
            ...
            $.ajax({
                url: "/permission/sys/role/changeAcls.json",
                data: {
                    roleId: lastRoleId,
                ...
                success: function (result) {
                    if (result.status == 200) {
                        ...
                        showMessage("保存角色与权限点的关系", result.message, false);
                    }
                }
            });
        });
        ...
        function updateRole(isCreate, successCallback, failCallback) {
            $.ajax({
                url: isCreate ? "/permission/sys/role/saveSysRole.json" : "/permission/sys/role/updateSysRole.json",
        ...
        function loadRoleUser(selectedRoleId) {
            $.ajax({
                url: "/permission/sys/role/users.json",
                data: {
                    roleId: selectedRoleId
                },
                type: 'GET',
                success: function (result) {
                    if (result.status == 200) {
                        ...
                        showMessage("加载角色用户数据", result.message, false);
                    }
                }
            });
        }
        ...
        $(".saveRoleUser").click(function (e) {
            ...
            $.ajax({
                url: "/permission/sys/role/changeUsers.json",
                data: {
                    roleId: lastRoleId,
                ...
                success: function (result) {
                    if (result.status == 200) {
                        ...
                        showMessage("保存角色与用户的关系", result.message, false);
                    }
                }
            });
        });
