                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="dataTables_length" id="dynamic-table_length"><label>
                                ...
                                开始时间：<input type="search" name="fromTime" id="search-from" class="form-control input-sm" placeholder="开始时间" aria-controls="dynamic-table"  onclick="WdatePicker({dateFmt:'yyyy-MM-dd'})"/>~
                                结束时间：<input type="search" name="toTime" id="search-to" class="form-control input-sm" placeholder="结束时间" aria-controls="dynamic-table" onclick="WdatePicker({dateFmt:'yyyy-MM-dd'})"/></br>
                                &nbsp;&nbsp;&nbsp;&nbsp;
...
<%--引入时间控件js--%>
<script src="/permission/My97DatePicker/WdatePicker.js"></script>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            function loadLogList() {
                ...
                var url = "/permission/sys/log/pageSysLog.json";
            ...
            function renderLogListAndPage(result, url) {
                if (result.status == 200) {
                   ...
                   /* var pageNo = $("#logPage .pageNo").val() || 1;*/
                    ...
                    renderPage(url, total, pageNo, pageSize, currentSize, "logPage", renderLogListAndPage);
                } else {
            ...
            function bindLogClick() {
                $(".log-edit").click(function (e) {
                    ...
                    if (confirm("确定要还原这个操作吗?")) {
                        $.ajax({
                            url: "/permission/sys/log/recover.json",
                            data: {
                                id: logId
                            },
                            type: 'POST',
